...
"${CC:-clang}" $flags "$root/wine-nx-probe/tests/sd_write_buffer.c" -o "$build/sd_write_buffer"
"${CC:-clang}" $flags "$root/wine-nx-probe/tests/sd_stat_cache.c" -o "$build/sd_stat_cache"
"$build/sd_stat_cache"
"$build/sd_write_buffer"
"$build/sd_read_cache"
"${CC:-clang}" $flags "$root/wine-nx-probe/tests/box64_code_arena.c" -o "$build/box64_code_arena"
...
python3 "$root/wine-nx-probe/tests/check_core_affinity.py"
"${CC:-clang}" $flags "$root/wine-nx-probe/tests/box64_options.c" -o "$build/box64_options"
"$build/box64_options"
"${CC:-clang}" $flags "$root/wine-nx-probe/tests/fex_options.c" -o "$build/fex_options"
"$build/fex_options"
...
python3 "$root/wine-nx-probe/tests/check_user_profile.py"
...
python3 "$root/wine-nx-probe/tests/check_d3dkmt_resources.py"
